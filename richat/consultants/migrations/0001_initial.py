# Generated by Django 5.1.7 on 2025-04-29 14:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('A_venir', 'À venir'), ('En_cours', 'En cours'), ('Termine', 'Terminé')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Projet',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expertise', models.CharField(default='Débutant', max_length=50)),
                ('is_validated', models.BooleanField(default=False, verbose_name="Validé par l'admin")),
                ('domaine_principal', models.CharField(choices=[('DIGITAL', 'Digital et Télécoms'), ('FINANCE', 'Secteur bancaire et financier'), ('ENERGIE', 'Transition énergétique'), ('INDUSTRIE', 'Industrie et Mines')], default='DIGITAL', max_length=20, verbose_name='Domaine principal')),
                ('specialite', models.CharField(default='', max_length=100, verbose_name='Sous-domaine')),
